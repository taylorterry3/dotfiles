...
## Export a .py version when saving a notebook
# This is the common way of doing this, with a check added so it doesn't fire on
# Untitled notebbooks.his SO post suggests that it kicks 
# off a thread and suggests a better way of doing this:
# https://stackoverflow.com/a/40660990
...
def post_save(model, os_path, contents_manager):
    ...
    # now fix execution counts for a cleaner git dif
    # Doesn't work yet
    # fname_py = os.path.splitext(fname)[0] + '.py'
    # with fileinput.FileInput(files=fname_py, inplace=1) as file:
    #     for line in file:
