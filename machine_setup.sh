...
apt-get install build-essential curl fluxgui git-core google-chrome-stable julia libapparmor1 libcurl4-openssl-dev libjpeg62 libmysqlclient-dev libreadline-dev libsqlite3-dev libssl-dev libxml2-dev libxslt1-dev libyaml-dev lm-sensors mysql-server mysql-common mysql-client openvpn pgadmin3 postgresql-9.3 postgresql-contrib-9.3 postgresql-server-dev-9.3 python-bs4 python-software-properties qgis r-base rbenv ruby ruby-build ruby-dev spotify-client-qt sqlite3 tmux vim zlib1g-dev
